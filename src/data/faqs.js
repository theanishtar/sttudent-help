...
export const faqAccordions = [
	{
		...
		description: '<p class = "mb-0">Once you’re set up, payouts arrive in your bank account on a 2-day rolling basis. Or you can opt to receive payouts weekly or monthly.</p>',
	},
	{
		id: 1,
		title: 'How do refunds work?',
		description: '<p class = "mb-0">You can issue either partial or full refunds. There are no fees to refund a charge, but the fees from the original charge are not returned.</p>',
	},
	{
		id: 2,
		title: 'How much do disputes costs?',
		description: '<p class = "mb-0">Disputed payments (also known as chargebacks) incur a $15.00 fee. If the customer’s bank resolves the dispute in your favor, the fee is fully refunded.</p>',
	},
	{
		id: 3,
		title: 'Is there a fee to use Apple Pay or Google Pay?',
		description: '<p class = "mb-0">There are no additional fees for using our mobile SDKs or to accept payments using consumer wallets like Apple Pay or Google Pay.</p>',
	},
];
...
export const faqDoc = [
    ...
    Please check the following link to see How to Getting started in Falcon React: <a target='_blank' href='//$/documentation/getting-started'>$/documentation/getting-started<a/>.</p>`,
	},
	{
		id: 2,
		title: 'Is there a specific version of Node.js I should use for Falcon React?',
	...
	{
		id: 5,
		title: 'Which bootstrap react framework you are using? Reactstrap or React-Bootstrap?',
	...
	},
	{
		...
		description: `<p >You will find the Figma link in the <code>README.md</code> file on your downloaded copy of Falcon. Here is the detailed documentation: <a target='_blank' href='///documentation/design-file'> /documentation/design-file</a>.</p>
	...
	{
		id: 7,
		title: 'What are the bare minimum files just to get the layout and navigation?',
    ...
    Check the link below to have a look on the styling documentation in Falcon React <a target='_blank' href='///documentation/styling'> /documentation/styling</a>
    </p>`,
	},
	{
		id: 9,
    ...
    Check out the following link and follow the changes: <a target='_blank' href='///changelog'> /changelog</a>
    </p>
